...
public String getGroovyPageFileName() { "/WEB-INF/plugins/kickstart-with-bootstrap-1.0.0/grails-app/views/_common/modals/_deleteDialog.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(5)
invokeTag('actionSubmit','g',20,['class':("btn btn-danger"),'action':("delete"),'value':(message(code: 'default.button.delete.label', default: 'Delete'))],-1)
printHtmlPart(6)
})
