...
public String getGroovyPageFileName() { "/WEB-INF/plugins/kickstart-with-bootstrap-1.0.0/grails-app/views/_menu/_language.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(1)
expressionOut.print(resource(plugin: 'kickstart-with-bootstrap', dir: 'images/flags',file: lang.toString()+'.png'))
printHtmlPart(2)
expressionOut.print(currentURL+'?lang=en')
printHtmlPart(3)
expressionOut.print(resource(plugin: 'kickstart-with-bootstrap', dir: 'images/flags',file: 'en.png'))
printHtmlPart(4)
...
printHtmlPart(11)
expressionOut.print(resource(plugin: 'kickstart-with-bootstrap', dir: 'images/flags',file: locale+'.png'))
printHtmlPart(12)
