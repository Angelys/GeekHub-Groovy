...
public String getGroovyPageFileName() { "/WEB-INF/plugins/kickstart-with-bootstrap-1.0.0/grails-app/views/_errors/500.gsp" }
public Object run() {
Writer out = getOut()
...
if(true && (exception)) {
printHtmlPart(23)
for( _it6616592 in (exception.stackTraceLines) ) {
changeItVariable(_it6616592)
...
public static final long LAST_MODIFIED = 1383556918000L
