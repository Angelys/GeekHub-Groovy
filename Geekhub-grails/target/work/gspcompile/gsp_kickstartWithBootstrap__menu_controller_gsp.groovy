...
public String getGroovyPageFileName() { "/WEB-INF/plugins/kickstart-with-bootstrap-1.0.0/grails-app/views/_menu/_controller.gsp" }
public Object run() {
Writer out = getOut()
...
public static final long LAST_MODIFIED = 1387109524000L
