...
class gsp_ironClash_homeindex_gsp extends GroovyPage {
...
createTagBody(2, {->
printHtmlPart(6)
invokeTag('render','g',10,['template':("/_menu/menubar")],-1)
printHtmlPart(5)
})
invokeTag('captureContent','sitemesh',11,['tag':("menubar")],2)
printHtmlPart(3)
})
...
public static final long LAST_MODIFIED = 1388997675000L
