...
public String getGroovyPageFileName() { "/WEB-INF/plugins/kickstart-with-bootstrap-1.0.0/grails-app/views/siteinfo/systeminfo.gsp" }
public Object run() {
Writer out = getOut()
...
printHtmlPart(8)
invokeTag('message','g',34,['code':("default.systeminfo.status")],-1)
printHtmlPart(9)
invokeTag('meta','g',36,['name':("app.version")],-1)
printHtmlPart(10)
invokeTag('meta','g',37,['name':("app.grails.version")],-1)
printHtmlPart(11)
...
printHtmlPart(18)
invokeTag('message','g',49,['code':("default.systeminfo.plugins")],-1)
printHtmlPart(19)
invokeTag('set','g',52,['var':("pluginManager"),'value':(applicationContext.getBean('pluginManager'))],-1)
printHtmlPart(20)
...
public static final long LAST_MODIFIED = 1387096400000L
