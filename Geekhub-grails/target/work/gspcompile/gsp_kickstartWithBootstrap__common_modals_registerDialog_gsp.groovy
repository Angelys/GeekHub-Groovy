...
public String getGroovyPageFileName() { "/WEB-INF/plugins/kickstart-with-bootstrap-1.0.0/grails-app/views/_common/modals/_registerDialog.gsp" }
public Object run() {
Writer out = getOut()
...
public static final long LAST_MODIFIED = 1387103342000L
